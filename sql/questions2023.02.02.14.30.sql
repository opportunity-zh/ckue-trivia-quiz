...
(3, 'music', 'Which rapper married TV star Kim Kardashian?', 'Kanye West', 'Snoop Doggy Dog', '50 Cents', 'LL Cool J', 'Eminem', 'answer-1'),
(4, 'music', 'Sometimes, fans like to believe that they see secret messages on the covers of record albums. According to a 1969 rumor, secret messages on album covers revealed that which Beatle had died in 1966?', 'Ringo Starr', 'John Coltraine', 'George Harrison', 'Elton John', 'Paul McCartney', 'answer-5'),
(5, 'music', 'Which controversial and collectable single by The Sex Pistols was banned by the B.B.C', 'God Save the Queen', 'Holidays in the Sun', 'Anarchy in the U.K.', 'Pretty Vacant', '', 'answer-1'),
(6, 'music', 'In which US city was the Dixieland jazz style developed?', 'New York', 'Chicago', 'New Orleans', 'Detroit', '', 'answer-3'),
(7, 'music', 'The Boogie genre is closest to these styles:', 'Punk/New Wave', 'Disco/Funk', 'Hard Rock/Heavy Metal', 'Boogie-Woogie', 'Synth-Pop', 'answer-2'),
(8, 'music', 'the Ramones arrived on the American music scene and are sometimes cited as the first true punk band. In which year did they release their debut album?', '1969', '1985', '2002', '1976', '1995', 'answer-4'),
(9, 'music', 'Farrokh Bulsara is/was the real name of…', 'Freddie Mercury\'', 'Frank Zappa', 'John Lennon', 'Sam Bankman Freed', 'Greta Thunfisch', 'answer-1'),
(10, 'music', 'The Hammond Organ has influenced genres from R&B, Jazz, Gospel, Funk to Hard Rock. It was first manufactured in', '1992', '1962', '1893', '1935', '1927', 'answer-4'),
(11, 'music', 'did Ozzy Osbourne really bite the head off a real bat during a concert?', 'No', 'Yes', 'Half-true', '', '', 'answer-2'),
(12, 'music', 'What does the name “ukulele” mean in Hawaiian?', 'jumping flea', 'waging dog', 'creepy snail', 'waging tail', 'agile ants', 'answer-1'),
(13, 'music', 'According to Guinness World Records, Madonna is the best selling female artist of all-time. By combining her unique abilities as a singer, songwriter and performer, she has become the most successful solo act in popular music. Which of her best selling si', 'Hung Up', 'Vogue', 'Like a Prayer', 'Music', '', 'answer-2'),
(14, 'music', 'Which one of the following chord symbols describes a dominant seventh chord', 'Am7b5', 'G7', 'Cmaj7', 'Dbo7', 'F#o7', 'answer-2'),
(15, 'music', 'Which early punk band caused a storm in Britain with singles like \'Anarchy in the U.K.\' and \'God Save the Queen\'? Hint ', 'Sex Pistols', 'The Who', 'The Dead Kennedys', 'The Ramones', 'The Stooges', 'answer-1'),
(16, 'music', 'The first Hammond organ, the Hammond Model A, started production in this year:', '1892', '1901', '1943', '1935', '1985', 'answer-3'),
(17, 'music', 'Which of the following styles preceded Be Bop?', 'Swing', 'Funk', 'Hip Hop', 'Rockabilly', 'Glam Rock', 'answer-1'),
...
(19, 'music', 'Towards the end of the 1970s. Which style originating in Jamaica was mixed with punk to create a genre known as two-tone?', 'Hony tonk', 'Igbo rap', 'Bhangra', 'Ska', 'Reggae', 'answer-4'),
(20, 'music', 'The “Model-A” was the first Hammond Organ that hit the market. The most legendary Model, that came out 20 years later, was called…', 'Hammond Queen-B', 'Hammond Alpha-Male', 'Hammond FA-18', 'Hammond Model-D', 'Hammond B3', 'answer-5'),
(21, 'music', 'The saxophone is a popular jazz instrument, but what was its first use?', 'Symphonic', 'Hunting', 'Military', 'Recital', 'Samba', 'answer-3'),
(22, 'music', 'In the early 21st century, some bands with punk roots were given the label \'emo\' (even if they didn\'t associate themselves with the genre). What made the emo subgenre so controversial? ', 'Animal rights abuses', 'Links to self-harm and suicide', 'Implicit sexism', 'Anarchistic rhetoric', '', 'answer-2'),
(23, 'music', 'Most famous analogue synthesizers use this method to generate different timbres: ', 'frequency modulation', 'additive synthesis', 'analogue modeling', 'sampling technology', 'subtractive synthesis', 'answer-5'),
(24, 'music', 'Which one is NOT originally a South American genre of music?', 'Samba', 'Tango', 'Merengue', 'Klezmer', 'Bossa-Nova', 'answer-4'),
(25, 'music', 'In The Big Lebowski, The Dude can’t stand which band?', 'ABBA', 'Supertramp', 'Simon and Garfunkel', 'The Eagles', 'The Alan Parsons Project', 'answer-5'),
(26, 'music', 'What was Madonna\'s first top 10 hit?\n', 'Holiday', 'Papa Don’t Preach ', 'Like a Prayer', 'Like a virgin', 'La Isla Fea', 'answer-1'),
(27, 'music', 'The most famous Hammond Organs generate the frequencies mechanically and convert them to current by a process called… ', 'wavetable synthesis', 'electromagnetic induction', 'frequency modulation (fm)', 'subtractive synthesis', 'stepdown transformation', 'answer-2'),
(28, 'music', 'Johann Sebastian Bach was a composer and musician of which musical period?', 'Post-Modernism', 'Classical Period', 'Renaissance', 'Barock', 'Romantic Period', 'answer-4'),
(29, 'music', 'Which city is Techno said to originate from?', 'New York', 'Chicago', 'Detroit', 'Manchester', 'Houston', 'answer-3'),
...
(1301, 'basketball', 'What does NBA stand for ?', 'National Basketball Association ', 'No Balls Around ', 'Next Ball Amazing ', 'Natural Bread Association ', 'North Ballers Army ', 'answer-1'),
(1302, 'basketball', 'Who is the shortest player in NBA history to win the slam dunk contest?\r\n', 'Nate Robinson ', 'Spud Webb', 'Isaiah Thomas ', 'Muggsy Bogues ', 'Yao Ming ', 'answer-2'),
(1303, 'basketball', 'Who is the only player to win the NBA Defensive Player of the Year award four times in a row?', 'Kevin Garnet ', 'Dwight Howard ', 'Scottie Pippen ', 'Ben Wallace ', 'Nikola Jokic ', 'answer-4'),
(1304, 'basketball', 'Who holds the record for the most points scored in a single game in NBA history?\r\n', 'LeBron James', 'Kobe Bryant ', 'Wilt Chamberlain ', 'Elgin Baylor ', 'Michael Jordan ', 'answer-3'),
(1305, 'basketball', 'What was the original name of the Toronto Raptors?\r\n', 'Toronto Maggots', 'Toronto Dragons', 'Toronto Tree\'s ', 'Toronto Huskies', 'Toronto Burritos ', 'answer-4'),
(1306, 'basketball', 'Who holds the record for the most steals in a single game in NBA history?\r\n', 'Kawhi Leonard ', 'Bob Cousy ', 'John Stockton ', 'Derrick Rose ', 'Jason Kidd ', 'answer-3'),
(1307, 'basketball', 'What was the first year that the NBA introduced the slam dunk contest?\r\n', '1976-77', '1977-78', '1978-79', '1979-80', '1980-81', 'answer-3'),
(1308, 'basketball', 'Who is the only player in NBA history to win the regular season MVP, Finals MVP, All-Star Game MVP, and Defensive Player of the Year in the same season?', 'Hakeem Olajuwon\r\n', 'Gary Payton ', 'LeBron James', 'Marcin Gortat ', 'Magic Johnson ', 'answer-1'),
(1309, 'basketball', 'Which team has won the most NBA Championships in history?\r\n', 'Los Angeles Lakers', 'Boston Celtics', 'Miami Heat ', 'Portland Trail Blazers ', 'Golden State Warriors ', 'answer-2'),
